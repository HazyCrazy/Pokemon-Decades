...
MenuHandlers.add(:options_menu, :only_speedup_battles, {
  ...
  "order" => 25,
  "type" => EnumOption,
  "parameters" => [_INTL("All"), _INTL("Only Battles")],
  "description" => _INTL("Choose what in the game is sped up by pressing the [Q] Key."),
...
MenuHandlers.add(:options_menu, :battle_speed, {
  ...
  "order" => 26,
  "type" => EnumOption,
  "parameters" => [_INTL("x#{SPEEDUP_STAGES[0]}"), _INTL("x#{SPEEDUP_STAGES[1]}")],

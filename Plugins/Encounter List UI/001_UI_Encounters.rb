...
:HeadbuttLow => "Headbutt",#"Headbutt (rare)",
:HeadbuttHigh => "Headbutt",#"Headbutt (common)",
...
class EncounterList_Scene
  ...
  def drawPresent
	...
	#loctext += sprintf("<al><c2=7FF05EE8>Evolution Lines are Level Scaled (Lvl.30,31,50)</c2></al>")
	loctext += sprintf("<al><c2=7FF05EE8>Evolution Lines are Level Scaled</c2></al>")
